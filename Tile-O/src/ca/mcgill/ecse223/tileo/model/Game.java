...
public static final int SpareConnectionPieces = 32;
  ...
  //Game State Machines
  public enum Mode { DESIGN, GAME, GAME_WON, GAME_ROLLDIEACTIONCARD, GAME_CONNECTTILESACTIONCARD, GAME_REMOVECONNECTIONACTIONCARD, GAME_TELEPORTACTIONCARD, GAME_LOSETURNACTIONCARD, GAME_DRAWCARD, GAME_TAKETURN, GAME_SWAPPOSITIONACTIONCARD }
  private Mode mode;
