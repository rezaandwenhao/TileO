...
public class GameModePage extends TileOGamePage {
  ...
  //  private JLabel playerTurnLabel;
    ...
    private JLabel WinTileHintActionCardDescription;
    private JLabel TeleportAllPlayersActionCardDescription;
    private JLabel RevealTileActionCardDescription;
	// draw card 
	...
	public void initialize(){
		...
		revealTile.setLocation(70-50, 410+80);
	    panel.add(revealTile);
	    
		winHint = new JLabel("");
		winHint.setFont(new Font("Arial",Font.BOLD,15));
		winHint.setSize(250, 30);
		winHint.setForeground(Color.RED);
		winHint.setLocation(70-50, 410+80);
	    panel.add(winHint);
	 ...
	 // elements for rollDie ActionCard: 
		...
		WinTileHintActionCardDescription.setLocation(70-50, 560+80);
		...
		TeleportAllPlayersActionCardDescription.setLocation(70-50, 560+80);
		...
		RevealTileActionCardDescription.setLocation(70-50, 540+80);
	...
	class Panel extends JPanel{
	    ...
	    public void paintComponent(Graphics g) {
	        ...
	        */
	        ...
	        // TILE INFORMATION
	        g.setColor(Color.WHITE);
	        g.fillRect(15, 540, 250, 120);
	        g.setColor(Color.BLACK);
	        g.drawRect(15, 540, 250, 120);
